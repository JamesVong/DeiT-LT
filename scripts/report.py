...
Usage:
    python scripts/report.py                  # scan from repo root
...
# ---------------------------------------------------------------------------
# Paper baseline (Table 6, DeiT-LT Base B, AVG metric)
# ---------------------------------------------------------------------------
PAPER_OVERALL = 87.50
PAPER_HEAD    = 94.50
PAPER_MID     = 84.10
...
def main():
    ...
    print()
    print("=" * 78)
    print("  DeiT-LT  --  CIFAR-10 LT  IF=100  |  metric: AVG = (CLS + DIST) / 2")
    print("=" * 78)
    print_header()

    # Paper baseline
    print_row("Paper DeiT-LT (Table 6)",
              PAPER_OVERALL, PAPER_HEAD, PAPER_MID, PAPER_TAIL,
              note="<-- paper")
    print()
